...
\begin{align}
\Psi   = & R\sum_{n = 1}^{N}\sum_{m = 0}^{\mathrm{min}(n, M)} P_n^m(\cos\theta)[\kappa_n^m'\cos(m\phi) + l_n^m'\sin(m\phi)] \nonumber \\
=& -\frac{R}{\mu_0}\sum_{n = 1}^{N}\sum_{m = 0}^{\mathrm{min}(n, M)} P_n^m(\cos\theta)(2n+1)[\kappa_n^m\cos(m\phi) + l_n^m \sin(m\phi)] \\
\alpha = & R\sum_{n = 1}^{N}\sum_{m = 0}^{\mathrm{min}(n, M)} P_n^m(\cos\theta)[\psi_n^m'\cos(m\phi) + \xi_n^m' \sin(m\phi)] \nonumber \\
=& -\frac{1}{R\mu_0}\sum_{n = 1}^{N}\sum_{m = 0}^{\mathrm{min}(n, M)} P_n^m(\cos\theta)n(n+1)[\psi_n^m\cos(m\phi) + \xi_n^m \sin(m\phi)].
\end{align}
...
\{\psi_n^m, \xi_n^m\} =& -\frac{R^2\mu_0}{n(n+1)}\{\psi_n^m', \xi_n^m'\}.
\end{align}
