...
- **Gamera snapshots (11 representative events)** – example synthetic data from Sorathia et al. (2024) *provided via a [Zenodo repository](https://zenodo.org/records/16882035)*
